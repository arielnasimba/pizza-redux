...
import BGPIZZA from "../../assets/images/composition-bg.jpg"
import '../Detail/Detail.css'

import {addPizza} from '../reducers/pizzaListSlice'

export default function CardSelfPage() {
  ...
  const { id = 0 } = useParams();
    ...
    // // document.querySelector(".body_detail").style.overflo:


  return (
    <>
      <body className={`body_detail w-[100dvw] min-h-[100dvh]  flex flex-col overflow-y-hidden `}
